...
console.log(iss+location.iss_position.longitude)

// TODO Extract the longitude value, and log it to the console.
console.log(iss+location.iss_position.latitude)
...
{
    let conversionRate = euro*country
    return conversionRate
}
//console.log(convert(100, rates.DXB).toFixed(4))

// TODO write code to identify the currency symbol that has the highest exchange rate compared to Euros.
//    In other words, identify the property with the largest value. the answer is BRL (Brazilian Real) at 3.8959 BRL to 1 Euro.
let currency = Object.values
let max = Math.max(...currency)
console.log(`Highest currency value is: ${max}`)
...
console.log(`The 2017 Nobel Laureate for Literature was ` 
